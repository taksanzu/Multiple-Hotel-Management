<table class="table table-bordered">
    ...
    @forelse($userLists as $userList)
        <tr>
            ...
            <td>
                <a type="button" class="btn btn-primary btn-sm text-light" ><i class="fa-solid fa-pen-to-square fa fa-2xs"></i></a>
                <a type="button" class="btn btn-danger btn-sm text-light"><i class="fa-solid fa-trash fa-2xs"></i></a>
            </td>
        </tr>
    @empty
        <tr>
